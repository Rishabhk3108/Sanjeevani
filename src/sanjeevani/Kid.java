...
public class Kid extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel35.setText("When to Take Your Sick Child to a Healthcare Provider");
        ...
        jLabel139.setText("<html>Make sure your child gets plenty of fluids and rest. Before giving your child any medication, be sure to talk with your healthcare provider or pediatrician about the best treatment for your child’s ailments.<br><br>\n\nYou should not give younger children medications meant for older kids or adults. Dosage is important, so read labels carefully.<br><br>\n\nAlthough schools and child care centers may have their own rules, it is common for them to require the following before a child can return to the setting:<br><br>\n\n        1.  No fever over 100.4 for 24 hours<br><br>\n        2.  No vomiting and/or diarrhea for 24 hours<br><br>\n        3.  On antibiotics for 24 hours, if applicable<br><br>\nIf a child is uncomfortable, tired, or in a great deal of pain, they're better off recuperating at home.<br><br>\n\nThese symptoms should keep a child home until cleared by a healthcare provider:</html>");

        jLabel141.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel141.setText("<html>You should also know the symptoms of COVID-19 in children and be familiar with your school or care center's coronavirus policies.</html>");

        jLabel49.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        jLabel49.setText("Warning Signs");

        jLabel67.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel67.setText("<html>A simple phone call to a nurse or an appointment with a healthcare provider can help ease your mind if something just doesn’t seem right. However, you should seek medical care if your child is experiencing:</html>");

        jLabel68.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel68.setText("<html><ul><li>High or persistent fever</li><br><li>Any breathing problems, such as fast, labored, or noisy breathing from the chest\n</li><br><li>Persistent pain, such as an earache, sore throat, severe headache, or stomach ache\n</li><br><li>Eye discharge that is thick, sticks the eyelids shut, and doesn’t get better during the day\n</li></ul></html>");

        jLabel69.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel69.setText("<html><ul><li>Frequent vomiting or diarrhea</li><br><li>Not keeping down enough liquid to urinate at least once every six to eight hours\n</li><br><li>Dehydration (severe dehydration needs to be treated in the emergency room)\n</li><br><li>Vomit or diarrhea that contains blood</li><br><li>\tA stiff neck, extreme lack of energy, or illness seems to be getting worse (rather than staying the same) for more than four to five days\n</li><br><li>Exposure to a contagious illness, such as mono, influenza, chickenpox, or COVID-19\n</li><br><li>Illness after recently traveling out of the country</li><br><li>Urinary problems, which may indicate an infection or, sometimes, diabetes</li></ul></html>");

        jLabel71.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel71.setText("<html>Additionally, you may need to have your child seen for:</html>");
        jLabel71.setPreferredSize(new java.awt.Dimension(689, 21));

        jLabel73.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        jLabel73.setText("Homecare");

        jLabel74.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel74.setText("<html><ul><li>High or persistent fever</li><br><li>Excessive fatigue</li><br><li>Rashes that could be contagious</li><br><li>Difficulty breathing</li><br><li>Frequent cough</li><br><li>Thick eye discharge</li><br><li>Dehydration</li><br><li>Repeated episodes of vomiting or diarrhea</li></ul></html>");

        jLabel42.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        jLabel42.setText("Fever");

        jLabel44.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel44.setText("<html>It’s important to pay attention to how a child is acting with a fever. If they have a high fever but are playful and active, the illness may be less concerning.<br><br>\n\nChildren’s fevers may reach different heights (some tend to run high whenever they’re sick, while others rarely have high temperatures), so it is important to pay attention to how a child is acting and eating/drinking.<br><br>\n\nFor newborns (under 2 months), any fever over 100.4 degrees Fahrenheit (F) requires evaluation. For children 3 months to 1 year, a fever higher than 102 F is worrisome.\n<html>");
        ...
        jLabel51.setText("<html>In general, there isn’t a set cutoff number for children’s fevers, but the symptoms occurring alongside the fever are very significant. For example, fast or labored breathing may signal that the child has a serious illness.</html>");
        ...
        jLabel52.setText("Vaccinations");

        jLabel53.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel53.setText("<html>It's important for children 6 months and older to get a flu vaccine.4 Another option is the nasal flu spray vaccine, which may be used for children age 2 years and older who don't have asthma.<br><br>\n\nChildren under 2 are at risk for hospitalization from flu complications like pneumonia. The vaccine protects them from serious complications and can keep them from spreading flu to people with poor immune systems, such as babies or older people.<br><br>\n\nTo reduce your child's distress during vaccinations, try a distraction like singing or watching a video. Ask your healthcare provider about numbing the spot with a freezing spray, ice pack, or lidocaine cream, and make sure the cream has enough time to work.<br><br>\nAmerican Academy of Pediatrics. Tear-free vaccination tips.\n\n\nOlder children may also appreciate it if a parent gets a shot with them.</html>");
                    ...
                    .addGroup(jPanel9Layout.createSequentialGroup()
                        .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                ...
                                .addComponent(jLabel69, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 700, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel9Layout.setVerticalGroup(
            ...
            .addGroup(jPanel9Layout.createSequentialGroup()
                ...
                .addGap(7, 7, 7)
                .addComponent(jLabel139, javax.swing.GroupLayout.PREFERRED_SIZE, 399, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jPanel2, javax.swing.GroupLayout.PREFERRED_SIZE, 1706, Short.MAX_VALUE)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addContainerGap()
