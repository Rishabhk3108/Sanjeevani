...
public class Nose extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel35.setText("4 Common Ear, Nose and Throat Problems");
        ...
        jLabel47.setText("<html>There are many different ear, nose, and throat (ENT) disorders and an even greater variety of characteristic symptoms. The following list involves the four most common ENT disorders. Not everyone will experience the same set of symptoms or have them as intensely. In some cases, a healthcare provider or ENT specialist will be needed to make the correct diagnosis and offer the appropriate treatment.</html>");

        jLabel55.setIcon(new javax.swing.ImageIcon(getClass().getResource("/sanjeevani/nose1.jpg"))); // NOI18N
        ...
        jPanel10Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel10Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabel55, javax.swing.GroupLayout.PREFERRED_SIZE, 628, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabel139.setText("<html>Apnea is a medical term meaning to stop breathing. Sleep apnea is a disorder causing one to stop breathing for brief periods of time while sleeping. Symptoms include:</html>");

        jLabel141.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel141.setText("<html>In addition to these symptoms, many individuals with sleep apnea have been told by a spouse or family member that they snore, gasp, choke, or even stop breathing momentarily while sleeping. You are more likely to have sleep apnea if you are overweight, have enlarged tonsils, or take sedatives at bedtime.<br><br>Obstructive sleep apnea (OSA) occurs in 2% of middle-aged women and 4% of middle-aged men, particularly those who are obese. If left untreated, sleep apnea can cause potentially serious health complications, including hypertension (high blood pressure), coronary artery disease, stroke, and heart failure.</html>");
        ...
        jLabel49.setText("Ear Infections");

        jLabel82.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        jLabel82.setText("A Word From Sanjeevani");

        jLabel67.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel67.setText("<html>Ear infections are one of the most prevalent ENT disorders. They occur when germs become trapped inside the middle ear.<br><br>\nThe eustachian tube, a tiny canal that originates in the ear and drains into the back of the throat, usually keeps unwanted germs out. If this tube is too small or becomes swollen shut by swelling or clogged by fluid and mucus, bacteria, or other microbes can enter the ear and cause an infection. ​<br><br>\nSigns and symptoms of an ear infection include:</html>");

        jLabel68.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel68.setText("<html><ul><li>Pain and pressure</li><br><li>Fever</li><br><li>Loss of balance</li><br><li>Difficulty hearing</li><br><li>Nausea and vomiting</li><br><li>Fluid discharge (suggestive of a perforation)</li></ul></html>");

        jLabel69.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel69.setText("<html><ul><li>Pulling or tugging on the ears</li><br><li>Increased fussiness, especially at bedtime</li><br><li>Failure to startle at loud noises or respond to their name</li><br><li>Eating or drinking abnormally</li></ul></html>");

        jLabel71.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel71.setText("<html>Ear infections are more common in children than adults and the most common type of infection in infants and toddlers.1 If a young child has an ear infection, it can often be difficult to detect. Telling signs in infants and toddlers include:</html>");
        jLabel71.setPreferredSize(new java.awt.Dimension(689, 21));

        jLabel73.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        jLabel73.setText("Sleep Apenea");

        jLabel74.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel74.setText("<html><ul><li>Waking up frequently in the middle of the night</li><br><li>Feeling unrefreshed upon awakening</li><br><li>Daytime drowsiness</li><br><li>Mood swings</li><br><li>Depression</li><br><li>Waking up with a dry, sore throat</li><br><li>Morning headaches</li></ul></html>");

        jLabel42.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        jLabel42.setText("Step Throat");

        jLabel44.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel44.setText("<html>Strep is an abbreviation for a family of bacteria called Streptococci. Strep throat occurs when the throat and surrounding structures become infected with this germ. While strep throat is a common infection, many other infections have the same symptoms.<br><br>\nSymptoms are usually abrupt in onset including:<html>");

        jLabel46.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel46.setText("<html><ul><li>Sore throat</li><br><li>Difficulty swallowing</li><br><li>Enlarged tonsils</li><br><li>Enlarged lymph nodes</li><br><li>White patches on the tonsils or back of the throat</li><br><li>Fever</li><br><li>Body aches</li><br><li>Fatigue</li></ul></html>");

        jLabel48.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel48.setText("<html>Notably absent in strep throat are a runny nose and cough. You may also suspect strep throat if you have been exposed to someone with a strep infection in the last two weeks. Children between the ages of 5 and 15 are most at risk. You are also more likely to get a strep infection during the winter months.</html>");
        ...
        jLabel51.setText("<html>Strep throat must be diagnosed by a throat culture or rapid antigen test at your healthcare provider's office to confirm a streptococcal infection versus a different bacterial or viral infection.</html>");
        ...
        jLabel52.setText("Sinusitis");

        jLabel53.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel53.setText("<html>Sinusitis occurs when a germ multiplies in the hollow recesses of the skull that surrounds your eyes and nose. The infection can become trapped, causing inflammation, pressure, and pain <br><br> Acute sinusitis is often secondary to a common cold, so you are more likely to get sinusitis during the winter months. Chronic sinusitis in which symptoms persist for more than 12 weeks may occur as a result of an untreated allergy or a chronic condition such as bronchial asthma.</html>");

        jLabel54.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel54.setText("<html>Symptoms of sinusitis include: <br><ul><li>Headache</li><br><li>Cough</li><br><li>Nasal discharge</li><br><li>Congestion</li><br><li>Fever</li><br><li>Fatigue</li><br><li>Toothache (mainly of the molars)</li><br></ul></html>");
                    ...
                    .addGroup(jPanel9Layout.createSequentialGroup()
                        .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                ...
                                .addComponent(jLabel46, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 689, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel9Layout.setVerticalGroup(
            ...
            .addGroup(jPanel9Layout.createSequentialGroup()
                ...
                .addGap(6, 6, 6)
                .addComponent(jLabel67, javax.swing.GroupLayout.PREFERRED_SIZE, 244, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel46, javax.swing.GroupLayout.PREFERRED_SIZE, 326, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(jLabel54, javax.swing.GroupLayout.PREFERRED_SIZE, 337, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel141, javax.swing.GroupLayout.PREFERRED_SIZE, 220, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
